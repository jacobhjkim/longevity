export const exercise = `# How to Exercise:
...
- It’s worth being cautious even if it means not doing certain things.

#### Create an exercise habit. 
- Do it everyday, no matter what (unless you’re injured, have a limiting medical condition, or under doctor's orders).
...
- In the luteal phase (second half), focus on lower-intensity activities like Zone 2 cardio and lighter strength training, as higher progesterone reduces exercise capacity and slows recovery.

#### Considerations for postmenopausal women: 
- Prioritize strength training and HIIT to help maintain muscle mass, improve insulin sensitivity, and protect bone density.
- Weight-bearing exercises are essential for reducing the risk of osteoporosis and maintaining overall functional strength as estrogen levels decline.
